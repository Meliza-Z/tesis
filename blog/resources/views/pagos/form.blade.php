        ...
        <div class="card-body">
            ...
            <form action="{{ $route }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="credito_id" class="form-label fw-bold">Crédito <span class="text-danger">*</span></label>
                            <select name="credito_id" id="credito_id" class="form-control form-control-sm" required>
                                ...
                                @foreach($creditos as $credito)
                                    <option value="{{ $credito->id }}" 
                                        ...
                                        Crédito #{{ $credito->id }} - {{ $credito->cliente->nombre ?? 'Cliente desconocido' }}
                                    </option>
                                @endforeach
                            </select>
                            @error('credito_id')
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="fecha_pago" class="form-label fw-bold">Fecha de Pago <span class="text-danger">*</span></label>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="monto_pago" class="form-label fw-bold">Monto del Pago <span class="text-danger">*</span></label>
                            <div class="input-group input-group-sm">
                                <span class="input-group-text">$</span>
                                <input type="number" step="0.01" name="monto_pago" id="monto_pago" class="form-control" 
                                    value="{{ old('monto_pago', $pago->monto_pago) }}" required min="0.01">
                            </div>
                            @error('monto_pago')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
