                        ...
                        <div class="col-md-6">
                            ...
                            <div class="info-group">
                                <p class="mb-2">
                                    ...
                                    <span class="badge bg-info">{{ \Carbon\Carbon::parse($credito->fecha_credito)->format('d/m/Y') }}</span>
                                </p>
                                <p class="mb-2">
                                    <i class="fas fa-calendar-times text-muted me-2"></i>
                                    <strong>Fecha de Vencimiento:</strong> 
                                    <span class="badge bg-warning">{{ \Carbon\Carbon::parse($credito->fecha_vencimiento)->format('d/m/Y') }}</span>
                                </p>
                                <p class="mb-0">
                                    <i class="fas fa-info-circle text-muted me-2"></i>
                                    <strong>Estado:</strong> 
                                    <span class="badge bg-{{ $credito->estado === 'activo' ? 'success' : ($credito->estado === 'vencido' ? 'danger' : 'secondary') }}">
                                ...
                                <div class="col-6">
                                    <div class="card bg-light border-0 text-center">
                                        <div class="card-body py-2">
                                            ...
                                            <h5 class="text-primary mb-0">${{ number_format($totalProductos, 2) }}</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="card bg-light border-0 text-center">
                                        <div class="card-body py-2">
                                            ...
                                            <h5 class="text-success mb-0">${{ number_format($totalPagado, 2) }}</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row g-4">
                        <div class="col-md-3">
                            <div class="text-center p-3 bg-light rounded">
                                ...
                                <h4 class="text-primary mb-0">${{ number_format($totalCredito, 2) }}</h4>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-center p-3 bg-light rounded">
                                ...
                                <h4 class="text-info mb-0">${{ number_format($totalProductos, 2) }}</h4>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-center p-3 bg-light rounded">
                        ...
                        <div class="col-md-3">
                            <div class="text-center p-3 bg-light rounded">
                                <i class="fas fa-{{ $saldoPendiente > 0 ? 'exclamation-triangle text-warning' : 'check-circle text-success' }} fa-2x mb-2"></i>
                                <h6 class="text-muted">Saldo Pendiente</h6>
                                <h4 class="text-{{ $saldoPendiente > 0 ? 'warning' : 'success' }} mb-0">
                    ...
                    @if($totalProductos > 0)
                        <div class="mt-4">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <span class="badge bg-primary">{{ round(($totalPagado / $totalProductos) * 100, 1) }}%</span>
                            </div>
                            <div class="progress" style="height: 8px;">
                                <div class="progress-bar bg-success" role="progressbar" 
                                     style="width: {{ ($totalPagado / $totalProductos) * 100 }}%"
                                     aria-valuenow="{{ $totalPagado }}" 
                                     aria-valuemin="0" 
