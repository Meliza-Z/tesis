...
<head>
    ...
    <style>
        body {
            ...
            min-height: 100vh;
            display: flex;
            /* Mantengo display flex en body para que sidebar y main-content-wrapper se distribuyan bien */
        ...
        .sidebar {
            ...
            position: fixed;
            /* Mantiene el sidebar fijo en la pantalla */
            top: 0;
            left: 0;
            height: 100vh;
            /* Ocupa toda la altura de la ventana */
            overflow-y: auto;
            /* Permite scroll si hay muchos elementos en el sidebar */
            z-index: 1030;
            /* Asegura que el sidebar esté por encima del contenido */
            transition: width 0.3s ease;
            /* Para futuras expansiones/contracciones */
        }
        ...
        .main-content-wrapper {
            margin-left: 250px;
            /* Empuja el contenido principal para que no se superponga con el sidebar */
            flex-grow: 1;
            /* Permite que el contenido ocupe el resto del ancho disponible */
            min-height: 100vh;
            /* Para que el fondo ocupe toda la altura */
            background-color: #f8f9fa;
            /* Fondo del área de contenido */
            display: flex;
            /* Para que el contenido interno pueda usar flexbox si se necesita */
...
<body>
    ...
    <div class="sidebar">
        ...
        {{-- <a href="{{ route('pagos.index') }}" class="{{ Request::is('pagos*') ? 'active' : '' }}">
            <i class="fas fa-money-bill-wave"></i> Gestion de Pagos
        </a> --}}
        ...
        <div
            style="position: absolute; bottom: 0; width: 100%; border-top: 1px solid rgba(255, 255, 255, 0.2); padding: 10px 0;">
            @auth
